package com.devprocedure.ui.base.textfield.prooutlinedtextfield
 ...
 */
@ComponentTheme
interface ProOutlinedTextFieldTheme {
    @Composable
    ...
    @Composable
    fun focusedBorderColor(): State<Color>

    @Composable
    fun unfocusedBorderColor(): State<Color>

    @Composable
    fun disabledBorderColor(): State<Color>

    @Composable
    fun errorBorderColor(): State<Color>
